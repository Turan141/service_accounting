...
const ProvisionOfProcessWater: React.FC<TenderItemProps> = ({
  formValues,
}) => {
  const TYPE = DocumentItemNamesEnum.ProvisionOfProcessWater;
  const CODE = ReferenceCodesOfServicesEnum.ProvisionOfProcessWater;
...
export default ProvisionOfProcessWater;
