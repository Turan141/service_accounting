...
const ProvidingAnExtensionCord: React.FC<TenderItemProps> = ({
                                                              formValues,
                                                            }) => {
  const TYPE = DocumentItemNamesEnum.ProvidingAnExtensionCord;
  const CODE = ReferenceCodesOfServicesEnum.ProvidingAnExtensionCord;
...
export default ProvidingAnExtensionCord;
