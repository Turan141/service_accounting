...
const SanitaryInspection: React.FC<TenderItemProps> = ({
                                                      formValues,
                                                    }) => {
  const TYPE = DocumentItemNamesEnum.SanitaryInspection;
  const CODE = ReferenceCodesOfServicesEnum.SanitaryInspection;
...
export default SanitaryInspection;
