...
const AircraftCooling: React.FC<TenderItemProps> = ({ formValues }) => {
  const TYPE = DocumentItemNamesEnum.AircraftCooling;
  const CODE = ReferenceCodesOfServicesEnum.AircraftCooling;
...
export default AircraftCooling;
