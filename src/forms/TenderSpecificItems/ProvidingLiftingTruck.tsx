...
import { AsyncSelect, Icon, Input, Checkbox } from 'react-lib';
...
const ProvidingLiftingTruck: React.FC<TenderItemProps> = ({
  formValues,
}) => {
  const TYPE = DocumentItemNamesEnum.ProvidingLiftingTruck;
  const CODE = ReferenceCodesOfServicesEnum.ProvidingLiftingTruck;
      ...
      <>
        ...
        <div className={styles.row}>
          <div className={styles.col}>
            <Checkbox.Redux
              name={'Работы по ТО ВС'}
              label={'Работы по ТО ВС'}
            />
          </div>
          <div className={styles.col}>
            <Checkbox.Redux
              name={'Работы общехозяйственного назначения'}
              label={'Работы общехозяйственного назначения'}
            />
          </div>
        </div>
        <Input.Redux label='Детализация работ*' name='detail' />
        <br/>
        <div className={styles.row}>
          <h1>Рабочий люльки АО "Ю-Ти-Джи"?</h1>
        </div>
        <br/>
        <div className={styles.row}>
          <div className={styles.col}>
            <Checkbox.Redux name={'Работы по ТО ВС'} label={'Да'} />
          </div>
          <div className={styles.col}>
            <Checkbox.Redux
              name={'Работы общехозяйственного назначения'}
...
export default ProvidingLiftingTruck;
