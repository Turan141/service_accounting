...
const GroundPowerUnit: React.FC<TenderItemProps> = ({ formValues }) => {
  const TYPE = DocumentItemNamesEnum.GroundPowerUnit;
  const CODE = ReferenceCodesOfServicesEnum.GroundPowerUnit;
    ...
    <div>
        ...
        <div className={styles.col}>
            <AsyncSelect.Redux
                ...
                label='Тип источника электропитания *'
              />
        </div>
        </div>
      {[
...
export default GroundPowerUnit;
