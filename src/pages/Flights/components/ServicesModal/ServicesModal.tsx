...
const ServicesModal: React.FC<ModalComponentProps & ServiceModalProps> = ({
    isOpen,
    handleClose,
    id,
}) => {
    ...
    return (
        ...
        >
            <div className={styles.header}>
                <span className={styles.title}>{data?.fullNumberOfFlight}</span>
                <div className={styles.tabWrapper}>
                    ...
                    >
                        <Tabs.Tab value={1} label="Услуги" />
                        <Tabs.Tab value={2} label="Отчет" />
                    </Tabs>
                </div>
            </div>
