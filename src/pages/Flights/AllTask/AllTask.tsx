import { checkAccess } from '@src/helpers/utils';
...
const AllTask = () => {
  ...
  const handleOnClick = useCallback(
    (link) => history.push(`${book.flights}/${link}`),
    [history],
  );
  return (
    <div className={styles.welcomeScreen}>
      <div className={styles.tabGrid}>
        ...
        `https://sso.dev.utg.group/auth/` ? (
          <div
            onClick={() => {
              handleOnClick('emergency');
            }}
            className={styles.card}
          >
            <Icon name={'emails'} />
            <h2>Экстренное оповещение</h2>
          </div>
        ) : (
          <div className={styles.card}></div>
        )}
        ...
        {checkAccess(['5']) ? (
          <div
            onClick={() => {
              handleOnClick('adminpanel');
            }}
            className={styles.card}
          >
            <Icon name={'internalAudit'} />
